...
public class HrController { 
	@Autowired
	private HrReactiveService hrService;
	
	@PostMapping
	public Mono<HireEmployeeResponse> hireEmployee(@RequestBody @Validated HireEmployeeRequest request) {
		return hrService.hireEmployee(request);
	}
	
	@DeleteMapping("{identity}")
	public Mono<FireEmployeeResponse> fireEmployee( @Validated @PathVariable @TcKimlikNo String identity) {
